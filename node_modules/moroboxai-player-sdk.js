(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MoroboxAIPlayerSDK = {}));
    ...
    class Controller {
        ...
        constructor(id, inputController) {
            this._id = id;
    ...
    class SpinnerChild {
        constructor(root, animationDelay) {
            ...
            this._el.style.animation = 'moroboxai-spinner-rotate 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite';
    ...
    class Spinner {
        constructor(root) {
            ...
            style.innerHTML = '@keyframes moroboxai-spinner-rotate {\n' +
                '   0% {\n' +
    ...
    class Overlay {
        constructor(root) {
            ...
            this._settingsOverlay.onSpeed = (value) => {
                if (this.onSpeed) {
                    this.onSpeed(value);
                }
            };
    ...
    const schema = [map, seq, string, nullTag, trueTag, falseTag, intBin, intOct, int, intHex, floatNaN, floatExp, float, binary, omap, pairs, set, intTime, floatTime, timestamp];
    ...
    */
     ...
     */
    function createFileServer(sdkConfig, baseUrl) {
        // Point to zip file
    ...
    (function (EPlayerState) {
        ...
        EPlayerState[EPlayerState["Loading"] = 1] = "Loading";
        EPlayerState[EPlayerState["BecomePlaying"] = 2] = "BecomePlaying";
        EPlayerState[EPlayerState["Playing"] = 3] = "Playing";
        EPlayerState[EPlayerState["Pause"] = 4] = "Pause";
    ...
    class Player {
        ...
        _attach() {
            ...
            this._ui.overlay.onSpeed = (value) => this.speed = value;
        ...
        _startGameServer() {
            return new Promise(resolve => {
                ...
                const fileServer = createFileServer(this._config, this._options.url);
        ...
        _loadBoot() {
            ...
            if (boot !== undefined) {
                ...
                if (boot.startsWith('http')) {
                    // direct URL
                    return fetch((_a = this.header) === null || _a === void 0 ? void 0 : _a.boot).then(res => {
                        if (!res.ok) {
            ...
            return new Promise((resolve, reject) => reject('failed to load boot'));
        }
        _loadGame() {
            return new Promise((resolve, reject) => {
                this._loadBoot().then(() => {
    ...
    function isPlayerOptions(_) {
        return _ !== undefined && !isElementArray(_) && !("className" in _);
    }
    function createPlayer(config, element, options) {
     ...
     */
    function init(config, element, options) {
        ...
        return Array.prototype.map.call(_elements, _ => createPlayer(config, _, _options));
    }
    class MetaPlayer {
        constructor(players) {
            this._players = [];
        ...
        play(options) {
            var _options = { url: undefined, header: undefined, autoPlay: true };
            if (options === undefined) ;
